...
<!-- START REVISION IOR FORM -->
<div class="modal animated zoomIn" id="modal_revision" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="col-md-12">
         <div class="modal-content">
            <form class="form-horizontal form-modalnya" id="form_revision_ior" action="#" method="post">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">Revision IOR No. <strong><span id="revsub"> </span></strong></h3>
                        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                    </div>
                    <div class="panel-body">                                                                        
                        <div class="row"> 
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="col-md-3 control-label">Revision By</label>
                                    <div class="col-md-9">                                            
                                        <div class="input-group">
                                            <input type="text" class="form-control" disabled="" value="<?=$this->session->userdata('occ_users_1103')->username; ?>" />
                                        </div>
                                ...
                                <div class="form-group">
                                    <label class="col-md-3 control-label">Change IOR Status</label>
                                    <div class="col-md-6">                                                           
                                        <select class='form-control' name='reopen' id='reopen' required="">
                                            <option value="0"> - </option>
                                            <option value="1"> OPEN</option>
                                            <option value="3"> CLOSE</option>
                                        </select>
                                        <span class="help-block">If yes, ior will be reopen and date estimated reset to 10 day</span>
                                    </div>
                                </div>
                                <!-- <div class="form-group">
                                    <label class="col-md-3 control-label">Next.Unit</label>
                                ...
                                <label class="col-md-12 control-label">Manage Follow Data</label>
                                <table class="table table-hover tbfontssz" id="rev_occ_follow">
                                        <input type="hidden" id="addfollid">
                                        <input type="hidden" id="follestimated" name="follestimated"/>
                                        <thead style="background-color: #0d0251; font-size: 10px;" >
                                            <tr>
                    ...
                    <div class="panel-footer">
                        <button class="btn btn-primary" type="submit" id="revbtn">Send</button>
                        <button class="btn btn-default" data-dismiss="modal">Back</button>
                    </div>
                    <input type="hidden" id="reopen_date" name="reopen_date" value="<?=$lastday?>" />
                    <input type="hidden" id="revparam" name="revparam"/>
                    <input type="hidden" id="revest" name="revest"/>
                </div>
            </form>
        </div>
    </div>
...
<!-- END  REVISION IOR FORM -->

<!-- START FILE HANDLER NCR -->
<div class="modal animated zoomIn" id="file_handler_ncr" role="dialog" aria-hidden="true" style="z-index: 10023000 ;">
    <div class="modal-dialog">
        <div class="modal-content">
         <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <form action="<?=site_url('fileupload/cobaupload')?>" class="dropzone" id="hallodzncr">
                    </form>
                </div>
                <div class="panel-footer">
                    <button class="btn btn-primary pull-right" onclick="check_file_ncr()">Submit</button>
                </div>
            </div>
        </div>
    </div>
...
<!-- START RISK CLOSE HANDLER-->
<div class="modal animated zoomIn" id="risk_index_close_select" role="dialog" aria-hidden="true" style="z-index: 9999999999999999999;">
    <div class="modal-dialog modal-lg" style="width: 100%;">
        <div class="modal-content">
         <div class="col-md-12">
            <div class="panel panel-default">
                <form id="form_risk_index_close" >
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="panel-title-box">
                                ...
                                <table class="table table-bordered table-striped table-hover list_probability" id="list_probability" style="font-size: 11px;">
                                    <thead style="background-color: #0d0251;">
                                        <tr>
                                            <th>Qualitative</th>
                                            <th>Meaning</th>
                            ...
                            <div class="col-md-8">
                                ...
                                <table class="table table-bordered table-striped table-hover list_severity" id="list_severity">
                                    <thead style="background-color: #0d0251;">
                                        <tr>
                                            <th>Aviation</th>
                                            <th>People</th>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
         ...
         <div class="panel-footer">
            ...
            <!-- <a href="" target="_blank" class="btn btn-primary pull-right" id="obj_file_nd2" download>Download 2</a> -->
            <a style="background-color: black ; " href="" target="_blank" class="btn btn-primary pull-right" id="obj_file_op">Open File</a>
        </div>
    </div>
</div>
</div>
            ...
            init: function() {
                this.on("success", function(file, serverFileName) {
                    fileList[i] = {"serverFileName" : serverFileName,"fileName" : file.name,"fileId" : i };
                        ...
                        var a = a.replace(/\s/g,'');
                        var fn =a.substring(0, 30);
                        var recep = '<input type="hidden" id="f1'+(i)+'" class="nm_file_ncr" name="file_name_ncr[]" value="'+a+'"><i class="fileclear" id="lb'+(i)+'">'+fn+'... <a id="bb'+(counter)+'" href="#" onclick="remove('+(i)+')" >remove</a><br></i>';
            ...
            init: function() {
                this.on("success", function(file, serverFileName) {
                        fileList[i] = {"serverFileName" : serverFileName,"fileName" : file.name,"fileId" : i };
                            ...
                            var recep = '<input type="hidden" id="f1fo'+(i)+'" class="nm_file_fo" name="file_name_fo[]" value="'+a+'"><i class="fileclear" id="lb'+(i)+'">'+fn+'... <a id="bb'+(counter)+'" href="#" onclick="remove('+(i)+')" >remove</a><br></i>';
