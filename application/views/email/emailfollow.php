...
<br><br>
<div>
<p>Please perform the follow-up of this Internal Occurrence Report before the report overdue. Please Immediately respond this occurrence report because if no response within 10 days then IOR system will issue NCR (Ref. QP 218-01).</p>
<p>Click here to see detail report via Internal Occurrence Report System.</p>
<p>Note : |this is the system generated message. Kindly do not reply</p>

<br>Cengkareng, <?=date('d-m-Y');?>
<br> PT Garuda Maintenance Facility Aero Asia
<br> Safety Inspection Unit, Room 1.13, 1st Floor, Hangar 2, Soekarno Hatta Int'l Airport.
<br> P : +62 21 550 8190
<br> E : <a href="mailto:list-TQY@gmf-aeroasia.co.id" target="_blank">list-TQY@gmf-aeroasia.co.id</a>
